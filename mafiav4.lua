...
mobBtnPositions={} StealBarRef=nil SavedPBCPos=nil
...
do
    ...
    PBC.Size=UDim2.new(0,240,0,42)
    PBC.Position=SavedPBCPos and UDim2.new(SavedPBCPos[1],SavedPBCPos[2],SavedPBCPos[3],SavedPBCPos[4]) or UDim2.new(0.5,-120,1,-100)
    StealBarRef=PBC
