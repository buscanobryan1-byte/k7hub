...
local ToggleIcon, MainFrame, SpeedCustomizer, XrayBase, NoAnim, PlayerESP, InfiniteJump, AutoPlay, AutoTp, AutoSteal
...
local function createTPDownUI()
    ...
    TPDown.btn.MouseButton1Click:Connect(function()
        TPDown.Active = not TPDown.Active
        if TPDown.Active then
            TPDown.btn.Text = "TP Down: ON"
...
AddToggle("Combat", "TP Down [F]", false, function(v)
    if v then
