...
TitleBar.Size=UDim2.new(1,0,0,52) TitleBar.BackgroundColor3=ACCENT TitleBar.BorderSizePixel=0
Instance.new("UICorner",TitleBar).CornerRadius=UDim.new(0,16)
local TitleFix=Instance.new("Frame",TitleBar)
TitleFix.Size=UDim2.new(1,0,0,16) TitleFix.Position=UDim2.new(0,0,1,-16)
TitleFix.BackgroundColor3=ACCENT TitleFix.BorderSizePixel=0
...
-- =========== STATS / PROGRESS BAR (pink outer, white inner) ===========
do
    local PBC=Instance.new("Frame",ScreenGui)
    PBC.Size=UDim2.new(0,340,0,50)
    PBC.Position=SavedPBCPos and UDim2.new(SavedPBCPos[1],SavedPBCPos[2],SavedPBCPos[3],SavedPBCPos[4]) or UDim2.new(0.5,-170,1,-100)
    StealBarRef=PBC
    ...
    local pbs=Instance.new("UIStroke",PBC) pbs.Color=ACCENT pbs.Thickness=2.5
    task.spawn(function()
        local grad=Instance.new("UIGradient",pbs)
        grad.Color=ColorSequence.new({ColorSequenceKeypoint.new(0,ACCENT),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(255,180,220)),ColorSequenceKeypoint.new(1,ACCENT)})
    ...
    hubLbl.Size=UDim2.new(0,88,0,24) hubLbl.Position=UDim2.new(0,12,0,4)
    hubLbl.BackgroundTransparency=1 hubLbl.Text="Mafia Hub" hubLbl.TextColor3=ACCENT
    hubLbl.Font=Enum.Font.GothamBlack hubLbl.TextSize=12 hubLbl.TextXAlignment=Enum.TextXAlignment.Left hubLbl.ZIndex=3
    -- separator
    local sep=Instance.new("TextLabel",PBC)
    sep.Size=UDim2.new(0,8,0,24) sep.Position=UDim2.new(0,100,0,4)
    sep.BackgroundTransparency=1 sep.Text="|" sep.TextColor3=ACCENT
    sep.Font=Enum.Font.GothamBold sep.TextSize=14 sep.ZIndex=3
    -- status
    ProgressLabel=Instance.new("TextLabel",PBC)
    ProgressLabel.Size=UDim2.new(0,58,0,24) ProgressLabel.Position=UDim2.new(0,110,0,4)
    ...
    ProgressPctLabel.Size=UDim2.new(0,28,0,24) ProgressPctLabel.Position=UDim2.new(0,168,0,4)
    ...
    FPSBar.Size=UDim2.new(0,56,0,24) FPSBar.Position=UDim2.new(0,196,0,4)
    ...
    PingBar.Size=UDim2.new(0,68,0,24) PingBar.Position=UDim2.new(0,254,0,4)
    ...
    rl.Text="R:" rl.TextColor3=PINK_TEXT rl.Font=Enum.Font.GothamBold rl.TextSize=9 rl.ZIndex=3
    ...
    -- Progress bar track: light pink bg, pink fill
...
do
    ...
    local autoBatBtn=makeMob("LOCK",UDim2.new(1,-120,0.5,-170+gap),"Lock",function()
        ...
        autoBatBtn.BackgroundColor3=ns and MOB_ON or MOB_OFF
    end)
