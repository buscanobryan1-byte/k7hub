...
local function refreshWPEsp()
    ...
    local R_CLR=Color3.fromRGB(255,120,120)
    local wpList={
...
MainStroke.Thickness=3 MainStroke.Color=ACCENT MainStroke.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
task.spawn(function()
...
-- Title bar: pink background
local TitleBar=Instance.new("Frame",MainFrame)
TitleBar.Size=UDim2.new(1,0,0,64) TitleBar.BackgroundColor3=ACCENT TitleBar.BorderSizePixel=0
...
TitleLbl.Size=UDim2.new(1,0,0,32) TitleLbl.Position=UDim2.new(0,0,0,0) TitleLbl.BackgroundTransparency=1 TitleLbl.Text="Mafia Hub"
TitleLbl.Font=Enum.Font.GothamBlack TitleLbl.TextSize=20 TitleLbl.TextColor3=WHITE
TitleLbl.TextXAlignment=Enum.TextXAlignment.Center TitleLbl.TextYAlignment=Enum.TextYAlignment.Center
TitleLbl.TextStrokeColor3=Color3.fromRGB(180,0,100) TitleLbl.TextStrokeTransparency=0.5

-- FPS/PING sub-bar inside title (like Kawatan Hub | FPS 56 PING 106ms)
local TitleSubBar=Instance.new("Frame",TitleBar)
TitleSubBar.Size=UDim2.new(1,0,0,20) TitleSubBar.Position=UDim2.new(0,0,0,32)
TitleSubBar.BackgroundColor3=Color3.fromRGB(30,30,40) TitleSubBar.BorderSizePixel=0 TitleSubBar.ZIndex=4
local TitleSubFix=Instance.new("Frame",TitleBar)
TitleSubFix.Size=UDim2.new(1,0,0,8) TitleSubFix.Position=UDim2.new(0,0,0,28)
TitleSubFix.BackgroundColor3=Color3.fromRGB(30,30,40) TitleSubFix.BorderSizePixel=0 TitleSubFix.ZIndex=3
local TitleHubLbl=Instance.new("TextLabel",TitleSubBar)
TitleHubLbl.Size=UDim2.new(1,0,1,0) TitleHubLbl.Position=UDim2.new(0,0,0,0) TitleHubLbl.BackgroundTransparency=1
TitleHubLbl.Text="Kawatan Hub  |  FPS 0  PING 0ms"
TitleHubLbl.Font=Enum.Font.GothamBold TitleHubLbl.TextSize=11 TitleHubLbl.TextColor3=Color3.fromRGB(160,220,255)
TitleHubLbl.TextXAlignment=Enum.TextXAlignment.Center TitleHubLbl.ZIndex=5

-- TAB BAR: two clickable tabs - FEATURES and SETTINGS
local TabBar=Instance.new("Frame",MainFrame)
TabBar.Size=UDim2.new(1,-20,0,28) TabBar.Position=UDim2.new(0,10,0,70) TabBar.BackgroundTransparency=1
...
local function makeScrollFrame()
    ...
    sf.Size=UDim2.new(1,-20,1,-108) sf.Position=UDim2.new(0,10,0,104)
...
do
    ...
    local rowStroke=Instance.new("UIStroke",tauntRow) rowStroke.Color=ACCENT rowStroke.Thickness=1 rowStroke.Transparency=0.7
    ...
    tauntLbl.Text="Taunt Spam" tauntLbl.TextColor3=PINK_TEXT tauntLbl.Font=Enum.Font.GothamBold
...
do
    ...
    makeSection(MovFrame,"  WAYPOINT SPEED EDITOR",34)
    do
...
do
    ...
    saveBtn.Size=UDim2.new(1,0,0,40) saveBtn.BackgroundColor3=ACCENT
...
do
    ...
    PBC.Size=UDim2.new(0,320,0,44)
    PBC.Position=SavedPBCPos and UDim2.new(SavedPBCPos[1],SavedPBCPos[2],SavedPBCPos[3],SavedPBCPos[4]) or UDim2.new(0.5,-160,1,-70)
    StealBarRef=PBC
    -- White inner background, solid pink outer border (matches menu)
    ...
    local pbs=Instance.new("UIStroke",PBC) pbs.Color=ACCENT pbs.Thickness=2.5 pbs.ApplyStrokeMode=Enum.ApplyStrokeMode.Border

    -- Hub name + FPS + PING on one line (pink text)
    local hubLbl=Instance.new("TextLabel",PBC)
    hubLbl.Size=UDim2.new(1,-16,0,24) hubLbl.Position=UDim2.new(0,10,0,4)
    hubLbl.BackgroundTransparency=1 hubLbl.Text="Kawatan Hub  |  FPS 0  PING 0ms"
    hubLbl.TextColor3=ACCENT hubLbl.Font=Enum.Font.GothamBold hubLbl.TextSize=12
    hubLbl.TextXAlignment=Enum.TextXAlignment.Left hubLbl.ZIndex=3
    -- status label READY/STEALING (pink text, right side)
    ProgressLabel=Instance.new("TextLabel",PBC)
    ProgressLabel.Size=UDim2.new(0,70,0,14) ProgressLabel.Position=UDim2.new(1,-78,0,6)
    ProgressLabel.BackgroundTransparency=1 ProgressLabel.Text="READY" ProgressLabel.TextColor3=PINK_TEXT
    ProgressLabel.Font=Enum.Font.GothamBold ProgressLabel.TextSize=9
    ProgressLabel.TextXAlignment=Enum.TextXAlignment.Right ProgressLabel.ZIndex=4
    -- steal % (pink)
    ProgressPctLabel=Instance.new("TextLabel",PBC)
    ProgressPctLabel.Size=UDim2.new(0,32,0,14) ProgressPctLabel.Position=UDim2.new(0,10,1,-16)
    ProgressPctLabel.BackgroundTransparency=1 ProgressPctLabel.Text="" ProgressPctLabel.TextColor3=ACCENT
    ProgressPctLabel.Font=Enum.Font.GothamBlack ProgressPctLabel.TextSize=9
    ProgressPctLabel.TextXAlignment=Enum.TextXAlignment.Left ProgressPctLabel.ZIndex=4
    -- Hidden FPS/PING labels (needed for updater)
    local FPSBar=Instance.new("TextLabel",PBC)
    FPSBar.Size=UDim2.new(0,1,0,1) FPSBar.BackgroundTransparency=1 FPSBar.Text="FPS 0"
    FPSBar.TextColor3=ACCENT FPSBar.Font=Enum.Font.GothamBold FPSBar.TextSize=1 FPSBar.Visible=false
    local PingBar=Instance.new("TextLabel",PBC)
    PingBar.Size=UDim2.new(0,1,0,1) PingBar.BackgroundTransparency=1 PingBar.Text="PING 0ms"
    PingBar.TextColor3=ACCENT PingBar.Font=Enum.Font.GothamBold PingBar.TextSize=1 PingBar.Visible=false
    -- Radius number only (pink, right side of progress bar, no "R:" label)
    RadiusInput=Instance.new("TextBox",PBC)
    RadiusInput.Size=UDim2.new(0,28,0,10) RadiusInput.Position=UDim2.new(1,-32,1,-13)
    RadiusInput.BackgroundTransparency=1 RadiusInput.Text=tostring(STEAL_RADIUS)
    RadiusInput.TextColor3=PINK_TEXT RadiusInput.Font=Enum.Font.GothamBold RadiusInput.TextSize=9
    RadiusInput.ZIndex=4 RadiusInput.BorderSizePixel=0 RadiusInput.ClearTextOnFocus=false
    RadiusInput.TextXAlignment=Enum.TextXAlignment.Right
    ...
    -- Progress bar track: light pink bg, solid pink fill (matches menu toggle style)
    local pt=Instance.new("Frame",PBC)
    pt.Size=UDim2.new(1,-38,0,5) pt.Position=UDim2.new(0,6,1,-12)
    pt.BackgroundColor3=Color3.fromRGB(255,210,235) pt.BorderSizePixel=0 pt.ZIndex=2
    ...
    RunService.RenderStepped:Connect(function()
        ...
        if ct-lft>=1 then fc=0 lft=ct end
        pcall(function()
            local ping=math.floor(Stats.Network.ServerStatsItem["Data Ping"]:GetValue())
            PingBar.Text="PING "..ping.."ms"
            hubLbl.Text="Kawatan Hub  |  FPS "..fc.."  PING "..ping.."ms"
            TitleHubLbl.Text="Kawatan Hub  |  FPS "..fc.."  PING "..ping.."ms"
        end)
    end)
    -- drag
...
do
    ...
    local function makeMob(label,initPos,toggleName,onAct)
        ...
        local s=Instance.new("UIStroke",btn) s.Color=WHITE s.Thickness=1.5 s.Transparency=0.3
    ...
    local autoBatBtn
    autoBatBtn=makeMob("LOCK",UDim2.new(1,-120,0.5,-170+gap),"Lock",function()
        ...
        if ns then
            autoBatBtn.Text="LOCKED"
            autoBatBtn.BackgroundColor3=WHITE
            autoBatBtn.TextColor3=MOB_ON
        else
            autoBatBtn.Text="LOCK"
            autoBatBtn.BackgroundColor3=MOB_ON
            autoBatBtn.TextColor3=WHITE
        end
    end)
    ...
    do
        ...
        local apBtn
        apBtn=makeMob("AUTO PLAY",UDim2.new(1,-120,0.5,-170),nil,function()
            AP_Toggle()
        end)
        ...
        AP_SetVisual=function(state)
            if state then
                apBtn.BackgroundColor3=WHITE
                apBtn.TextColor3=MOB_ON
                apBtn.Text="STOP AP"
            else
                apBtn.BackgroundColor3=MOB_ON
                apBtn.TextColor3=WHITE
                apBtn.Text="AUTO PLAY"
            end
        end
    end
    local tpMobBtn=makeMob("TP DOWN",UDim2.new(1,-120,0.5,-170+gap*2),nil,function() task.spawn(doTPDown) end)
    tpMobBtn.Visible=true tpMobBtnRef=tpMobBtn tpMobBtn.Size=UDim2.new(0,90,0,50)
    local autoMedBtn=makeMob("AUTO MED",UDim2.new(1,-120,0.5,-170+gap*3),nil,function()
...
do
    ...
    OBtn.BackgroundColor3=ACCENT OBtn.Text="M" OBtn.TextSize=26
