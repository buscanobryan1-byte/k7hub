...
local function enableWPEsp()
    ...
    for _,wp in ipairs(wpList) do
        ...
        p.Size=Vector3.new(1,1,1) p.Material=Enum.Material.Neon p.Color=wp[3] p.Position=wp[2] p.Parent=wpEspFolder
        local bb=Instance.new("BillboardGui",p)
        bb.Size=UDim2.new(0,120,0,40) bb.StudsOffset=Vector3.new(0,3,0) bb.AlwaysOnTop=true
