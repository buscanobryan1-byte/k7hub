...
local function AP_StartLeft()
    ...
    local lastMv=Vector3.zero local lastPh=-1 local lastPos=nil
    AP_LeftConn=RunService.Heartbeat:Connect(function()
        ...
        if lastPos and (Vector3.new(pos.X,0,pos.Z)-Vector3.new(lastPos.X,0,lastPos.Z)).Magnitude>15 then
