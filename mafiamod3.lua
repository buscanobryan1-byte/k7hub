...
local function startAutoPlayLeft()
    ...
    local waypoints={
        ...
        {pos=POS_L3,spd=WP_L_SPD[3]},{pos=POS_L4,spd=WP_L_SPD[4]},{pos=POS_L5,spd=WP_L_SPD[5]},{pos=POS_L6,spd=WP_L_SPD[6]},
    }
    task.spawn(function()
...
local function startAutoPlayRight()
    ...
    local waypoints={
        ...
        {pos=POS_R3,spd=WP_R_SPD[3]},{pos=POS_R4,spd=WP_R_SPD[4]},{pos=POS_R5,spd=WP_R_SPD[5]},{pos=POS_R6,spd=WP_R_SPD[6]},
    }
    task.spawn(function()
        for i,wp in ipairs(waypoints) do
