...
local function createBatUI()
    ...
    create("UIStroke", {Color = Color3.fromRGB(0, 220, 0), Thickness = 1.5, Parent = BatUI.btn})
...
local function createTPDownUI()
    ...
    create("UIStroke", {Color = Color3.fromRGB(0, 220, 0), Thickness = 1.5, Parent = TPDown.btn})
...
local function createDropUI()
    ...
    DropUI.btn.MouseButton1Click:Connect(function()
        ...
        if dropEnabled then
            ...
            DropUI.btn.BackgroundColor3 = Color3.fromRGB(60, 255, 60)
        else
            DropUI.btn.Text = "DROP: OFF"
            DropUI.btn.BackgroundColor3 = Color3.fromRGB(255, 60, 60)
        end
