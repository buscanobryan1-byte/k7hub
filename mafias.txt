...
Instance.new("UICorner",SpeedFloat).CornerRadius=UDim.new(0,12)
...
local sfBarFix=Instance.new("Frame",sfBar)
sfBarFix.Size=UDim2.new(1,0,0,12) sfBarFix.Position=UDim2.new(0,0,1,-12)
sfBarFix.BackgroundColor3=Color3.fromRGB(18,14,32) sfBarFix.BorderSizePixel=0
...
makeToggle(FeatFrame,"Speed Customizer",9,function(v) SpeedFloat.Visible=v end)
