...
--// J Hub Duels - RADIO CUADRADO ACOTADO SUBIDO (Y = -2.5)
...
RunService.RenderStepped:Connect(function()
    ...
    topLabel.Text = "J hub  Duels| "..fps.." FPS | "..ping.." ms"
end)
...
do
    ...
    editorGui.Name = "WaypointsEditorGui"
    editorGui.ResetOnSpawn = false
    editorGui.Enabled = false
    editorGui.Parent = CoreGui
    ...
    sep.BackgroundColor3 = Color3.fromRGB(0,120,255)
    ...
    leftTabBtn.BackgroundColor3 = Color3.fromRGB(0,120,255)
    ...
    hX.TextColor3 = Color3.fromRGB(0,120,255); hX.Font = Enum.Font.GothamBold; hX.TextSize = 11
    ...
    hZ.TextColor3 = Color3.fromRGB(0,120,255); hZ.Font = Enum.Font.GothamBold; hZ.TextSize = 11
    ...
    local function buildRows()
        ...
        for i, wp in ipairs(pts) do
            ...
            pLbl.Text = "P"..i
            pLbl.TextColor3 = Color3.fromRGB(0,120,255)
    ...
    local function showBoxes()
        ...
        local boxColor = currentPlot == 3
            and Color3.fromRGB(0, 120, 255)   -- blue for LEFT
        ...
        for i, wp in ipairs(pts) do
            ...
            part.BrickColor = BrickColor.new(boxColor == Color3.fromRGB(0,120,255) and "Bright blue" or "Bright red")
    ...
    local function selectTab(plot)
        ...
        if plot == 3 then
            ...
            rightTabBtn.BackgroundColor3 = Color3.fromRGB(0,120,255)
...
local function createAutoPlayUI()
    ...
    AutoPlay.btn.BackgroundColor3 = Color3.fromRGB(0, 120, 255)
...
local function enableAutoPlay()
    ...
    AutoPlay.renderConn = RunService.RenderStepped:Connect(function()
        ...
        if distance < 5 then
            ...
            local moveDir = (targetPos - r.Position).Unit
...
local function disableAutoPlay()
    ...
    AutoPlay.currentWaypoints = nil
    AutoPlay.currentWaypointIndex = 1
    if AutoPlay.gui then AutoPlay.gui.Enabled = false end
