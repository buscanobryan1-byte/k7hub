...
-- Title bar: dark hub-style
local TB_DARK=Color3.fromRGB(20,20,28)
local TitleBar=Instance.new("Frame",MainFrame)
TitleBar.Size=UDim2.new(1,0,0,44) TitleBar.BackgroundColor3=TB_DARK TitleBar.BorderSizePixel=0
Instance.new("UICorner",TitleBar).CornerRadius=UDim.new(0,16)
local TitleFix=Instance.new("Frame",TitleBar)
TitleFix.Size=UDim2.new(1,0,0,16) TitleFix.Position=UDim2.new(0,0,1,-16)
TitleFix.BackgroundColor3=TB_DARK TitleFix.BorderSizePixel=0
-- bottom accent line
...
TitleLbl.Font=Enum.Font.GothamBlack TitleLbl.TextSize=15 TitleLbl.TextColor3=WHITE
...
TitleStats.Font=Enum.Font.GothamBold TitleStats.TextSize=11 TitleStats.TextColor3=Color3.fromRGB(200,200,210)
...
do
    ...
    -- L WAYPOINT DELAY EDITOR
    makeSection(MovFrame,"  L WAYPOINT DELAYS",39)
    do
        local L_DLY_CLR=Color3.fromRGB(255,180,220)
        local function makeLDlyRow(order, label, idx)
            local row=Instance.new("Frame",MovFrame)
            row.Size=UDim2.new(1,0,0,44) row.BackgroundColor3=CARD row.BorderSizePixel=0 row.LayoutOrder=order
            Instance.new("UICorner",row).CornerRadius=UDim.new(0,10)
            local rowStroke=Instance.new("UIStroke",row) rowStroke.Color=ACCENT rowStroke.Thickness=1 rowStroke.Transparency=0.7
            ...
            lbl.Text=label lbl.TextColor3=PINK_TEXT lbl.Font=Enum.Font.GothamBold lbl.TextSize=13 lbl.TextXAlignment=Enum.TextXAlignment.Left
            local cap=Instance.new("TextLabel",row)
            cap.Size=UDim2.new(0,30,0,16) cap.Position=UDim2.new(0,40,0.5,-8) cap.BackgroundTransparency=1
            cap.Text="DLY" cap.TextColor3=L_DLY_CLR cap.Font=Enum.Font.GothamBold cap.TextSize=10
            local box=Instance.new("TextBox",row)
            box.Size=UDim2.new(0,80,0,28) box.Position=UDim2.new(0,70,0.5,-14)
            box.BackgroundColor3=Color3.fromRGB(255,230,242) box.Text=tostring(WP_L_DLY[idx])
            box.TextColor3=L_DLY_CLR box.Font=Enum.Font.GothamBold box.TextSize=13
            box.TextXAlignment=Enum.TextXAlignment.Center box.BorderSizePixel=0 box.ClearTextOnFocus=false
            Instance.new("UICorner",box).CornerRadius=UDim.new(0,6)
            local bs=Instance.new("UIStroke",box) bs.Color=ACCENT bs.Thickness=1 bs.Transparency=0.5
            local unitLbl=Instance.new("TextLabel",row)
            unitLbl.Size=UDim2.new(0,30,1,0) unitLbl.Position=UDim2.new(0,155,0,0) unitLbl.BackgroundTransparency=1
            unitLbl.Text="sec" unitLbl.TextColor3=PINK_TEXT unitLbl.Font=Enum.Font.Gotham unitLbl.TextSize=11
            box.FocusLost:Connect(function()
                local n=tonumber(box.Text)
                if n then WP_L_DLY[idx]=math.max(0,n) box.Text=tostring(WP_L_DLY[idx]) task.defer(saveConfig)
                else box.Text=tostring(WP_L_DLY[idx]) end
            end)
        end
        makeLDlyRow(40,"L1:",1)
        makeLDlyRow(41,"L2:",2)
    ...
    -- R WAYPOINT DELAY EDITOR
    makeSection(MovFrame,"  R WAYPOINT DELAYS",45)
    do
        local R_DLY_CLR=Color3.fromRGB(200,200,255)
        local function makeRDlyRow(order, label, idx)
            local row=Instance.new("Frame",MovFrame)
            row.Size=UDim2.new(1,0,0,44) row.BackgroundColor3=CARD row.BorderSizePixel=0 row.LayoutOrder=order
            Instance.new("UICorner",row).CornerRadius=UDim.new(0,10)
            local rowStroke=Instance.new("UIStroke",row) rowStroke.Color=ACCENT rowStroke.Thickness=1 rowStroke.Transparency=0.7
            ...
            local cap=Instance.new("TextLabel",row)
            cap.Size=UDim2.new(0,30,0,16) cap.Position=UDim2.new(0,40,0.5,-8) cap.BackgroundTransparency=1
            cap.Text="DLY" cap.TextColor3=R_DLY_CLR cap.Font=Enum.Font.GothamBold cap.TextSize=10
            local box=Instance.new("TextBox",row)
            box.Size=UDim2.new(0,80,0,28) box.Position=UDim2.new(0,70,0.5,-14)
            box.BackgroundColor3=Color3.fromRGB(230,230,255) box.Text=tostring(WP_R_DLY[idx])
            box.TextColor3=R_DLY_CLR box.Font=Enum.Font.GothamBold box.TextSize=13
            box.TextXAlignment=Enum.TextXAlignment.Center box.BorderSizePixel=0 box.ClearTextOnFocus=false
            Instance.new("UICorner",box).CornerRadius=UDim.new(0,6)
            local bs=Instance.new("UIStroke",box) bs.Color=ACCENT bs.Thickness=1 bs.Transparency=0.5
            local unitLbl=Instance.new("TextLabel",row)
            ...
            box.FocusLost:Connect(function()
                local n=tonumber(box.Text)
                if n then WP_R_DLY[idx]=math.max(0,n) box.Text=tostring(WP_R_DLY[idx]) task.defer(saveConfig)
                else box.Text=tostring(WP_R_DLY[idx]) end
            end)
        end
        makeRDlyRow(46,"R1:",1)
        makeRDlyRow(47,"R2:",2)
    ...
    makeNumInput(MovFrame,"Delay (s)",AP_DELAY,45,function(n)
...
do
    ...
    hubLbl.Size=UDim2.new(0,80,0,20) hubLbl.Position=UDim2.new(0,10,0,4)
    hubLbl.BackgroundTransparency=1 hubLbl.Text="Mafia Hub" hubLbl.TextColor3=Color3.fromRGB(200,200,220)
    ...
    sep.Size=UDim2.new(0,8,0,20) sep.Position=UDim2.new(0,90,0,4)
    sep.BackgroundTransparency=1 sep.Text="|" sep.TextColor3=Color3.fromRGB(100,100,120)
    sep.Font=Enum.Font.GothamBold sep.TextSize=13 sep.ZIndex=3
    -- FPS
    local FPSBar=Instance.new("TextLabel",PBC)
    FPSBar.Size=UDim2.new(0,60,0,20) FPSBar.Position=UDim2.new(0,100,0,4)
    FPSBar.BackgroundTransparency=1 FPSBar.Text="FPS 0" FPSBar.TextColor3=Color3.fromRGB(200,200,220)
    ...
    PingBar.Size=UDim2.new(0,70,0,20) PingBar.Position=UDim2.new(0,150,0,4)
    PingBar.BackgroundTransparency=1 PingBar.Text="PING 0ms" PingBar.TextColor3=Color3.fromRGB(200,200,220)
